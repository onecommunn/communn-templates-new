...
export default function InfluencerPageCopy() {
  ...
  // Right panel collapse (like image)
        ...
        {filteredPlaces.length === 0 ? (
          <div
            className="h-full flex flex-col items-center justify-center 
                  text-center text-slate-500 p-6"
          >
    ...
    <main className="relative min-h-screen bg-[#F6F7FB]">
        ...
        <div className="bg-white border-b sticky top-0 z-20">
          ...
          <div className="h-14 px-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button className="h-9 rounded-md bg-[#1F4AA8] hover:bg-[#163A87]">
                Explore
              </Button>
            </div>
          </div>
          ...
          <div className="px-6 max-w-screen pb-3 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            {/* Chips */}
            <div
              className="w-full md:flex-1 flex md:flex-wrap items-center gap-2 
                overflow-x-auto overflow-y-hidden 
                mr-10 pr-2 overscroll-x-contain"
            >
              ...
              {/* <ButtonGroup>
                <Button
                  ...
                  className={`cursor-pointer ${
                    panelOpen ? "border-slate-200 bg-slate-100" : ""
                  }`}
            ...
            <div className={`flex ${panelOpen ? "gap-4" : "gap-0"} `}>
              ...
              <div className="flex-1 min-w-0">
                <div className="bg-white rounded-xl border overflow-hidden relative h-[calc(100vh-204px)] md:h-[calc(100vh-140px)]">
                  ...
                  {/* IMPORTANT: top padding so chips don't overlap map */}
      ...
      <button
        ...
        className="md:hidden fixed left-1/2 -translate-x-1/2
             ...
             border border-slate-200 rounded-t-2xl
             py-1 px-14 bg-white hover:bg-gray-200 shadow-md"
      >
        <ChevronUp size={24} />
      </button>
    </main>
