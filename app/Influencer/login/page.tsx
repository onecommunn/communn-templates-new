...
const InfluencerLogin = () => {
  ...
  return (
    <main
      className="flex-grow flex h-screen items-center justify-center py-12 px-4 bg-[var(--pri)]/10 font-montserrat"
      style={
        {
          "--pri": primaryColor,
          "--sec": secondaryColor,
            ...
            <div className="space-y-6">
              <div className="text-center mb-6">
                <button
                  ...
                  className="cursor-pointer underline text-sm font-medium"
                  disabled={loading}
                  style={{ color: primaryColor }}
                >
              ...
              <div>
                ...
                <div className="flex gap-3 flex-col">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-[#000] focus:outline-none focus:ring-2"
                    disabled={loading}
                    style={{
                  ...
                  <button
                    ...
                    className={`text-white px-6 py-3 bg-[var(--pri)] rounded-lg font-medium w-full disabled:cursor-not-allowed disabled:bg-[var(--pri)]/60`}
                  >
