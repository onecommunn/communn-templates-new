...
export default function MadivalaTeamGrid({
    ...
    return (
        <section className="w-full bg-white">
            <div className="mx-auto w-full max-w-[520px] sm:max-w-[720px] lg:max-w-[1150px] px-0 py-8">
                {/* Title */}
                <h2 className="font-hedvig text-center text-[28px] md:text-[45px] font-[400] leading-tight pb-10">
                    2018-2019 ರಚುನಾವಣೆಯಲ್ಲಿಚುನಾಯಿತರಾದ <br />ಸಧಸ್ಯರುಗಳು
                </h2>
