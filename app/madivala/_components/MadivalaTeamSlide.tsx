...
const MadivalaTeamSlide = ({
  ...
  return (
    <section
      className="mx-auto w-full max-w-[1150px] px-6 md:px-0 py-10 md:py-16 bg-white"
    ...
    >
      <div className="flex items-center flex-col justify-center gap-3 mb-8 md:mb-12">
        <div className="flex items-center gap-2 text-[#1f5652]">
          ...
          <span className="flex items-center justify-center gap-2 font-inter text-2xl md:text-[16px]">
            {eyebrow}
          </span>
        </div>
