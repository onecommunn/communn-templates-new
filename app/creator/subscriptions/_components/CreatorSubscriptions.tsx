...
const CreatorSubscriptions = ({
  ...
  if (isPageLoading) {
    return (
      <main
        className="flex-grow font-sora bg-white"
        style={
          {
            "--pri": primaryColor,
            "--sec": secondaryColor,
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-20 py-10">
        ...
        <div className="mx-auto">
          <div>
            <div className="my-3">
              <h2 className="font-marcellus font-semibold text-xl my-2 text-[var(--sec)]">
                Payment Schedule
              </h2>
              <div>
                    ...
                    <button
                      ...
                      className={`px-8 py-2 cursor-pointer rounded-full text-sm font-medium transition-colors ${
                        activeTab === tab
                          ...
                          : "text-[var(--sec)] hover:text-[var(--sec)] hover:bg-[var(--sec)]/20"
                      }`}
                    >
                      {formatStatus(tab)}
                    </button>
                ...
                <div className="border bg-white rounded-2xl p-6 mt-2">
                  ...
                  <div className="grid grid-cols-2">
                    <div>
                      <h6 className="font-semibold text-[16px] mb-3 text-[var(--sec)]">
                        Total
                      </h6>
                    </div>
