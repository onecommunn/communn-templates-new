...
import { toSnakeCase, underscoreToSpace } from "@/utils/StringFunctions";
            ...
            <div className="hidden md:flex md:items-center">
              {auth.isAuthenticated ? (
                ...
                <Button
                  ...
                  className="cursor-pointer bg-white hover:bg-transparent hover:text-white text-[#0A2640] border border-white rounded-[10px] text-sm px-6 w-fit inline-flex items-center gap-2"
                >
                  Login
                  <span>
              ...
              <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
                ...
                >
                  ...
                  <div className="px-4 pt-2 pb-6">
                    <SheetClose asChild>
                      {!auth.isAuthenticated && (
                        <Button onClick={() => setIsLoginOpen(true)} className="rounded-[12px] text-sm px-5 w-full inline-flex items-center gap-2">
