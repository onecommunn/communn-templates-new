...
import { ContactFormSection } from "@/models/templates/collections/collections-contact-model";
...
const ContactFormCollection = ({
  ...
  return (
    <div
      className="bg-[var(--pri)]/20 p-6 md:p-10 rounded-sm w-full"
      style={
        {
          "--pri": primaryColor,
  ...
  "
        ...
        <Button
          type="submit"
          className="bg-[var(--pri)] rounded-none  border-none hover:bg-gold-dark text-primary-foreground font-figtree px-8"
        >
          Send Message
        </Button>
      </form>
