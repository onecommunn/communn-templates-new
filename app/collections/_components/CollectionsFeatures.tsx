...
import { FeaturesSection } from "@/models/templates/collections/collections-home-model";
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
            {content?.points?.map((feature, index) => (
              ...
              >
                <p className="text-[var(--pri)] font-serif text-xs lg:text-sm font-medium text-center">
                  {feature}
                </p>
              </div>
            ))}
