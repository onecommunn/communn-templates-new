...
import ConsultingoProfilePage from "./_components/ConsultingoProfilePage";


const ConsultingoProfileRoot = () => {
  ...
  return (
    <Suspense fallback={<ProfileSkeleton />}>
      <ConsultingoProfilePage
      />
    </Suspense>
  );
};

export default ConsultingoProfileRoot;
