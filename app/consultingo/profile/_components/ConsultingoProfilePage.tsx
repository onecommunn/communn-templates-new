...
const ConsultingoProfilePage = () => {
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-8 md:px-20 font-montserrat">
      <div className="container mx-auto space-y-8">
        {/* HEADER */}
        <div className="text-center space-y-2">
          <h1 className="text-xl md:text-4xl font-bold font-montserrat tracking-tight">
            Account
          </h1>
            ...
            <Card className="rounded-xl shadow-none border border-gray-200 p-3 md:p-6 md:py-[30px] h-fit">
              <CardContent className="p-0 flex md:flex-col items-center justify-start md:justify-center gap-6">
                <div className="relative">
                  <Avatar className="size-24 md:size-40 shadow-lg">
                    <AvatarImage
                  ...
                  <Button
                    size="icon"
                    className="absolute bottom-0 right-0 h-9 w-9 rounded-full border-2 border-white shadow-none cursor-pointer"
                    type="button"
            ...
            {/* <Card className="rounded-xl shadow-none border border-gray-200 p-3 md:p-6 md:py-[30px] h-fit">
              <CardContent className="p-0 flex flex-col gap-4 w-full">
                ...
                <Link href={"/#plans"}>
                  <button
                    type="button"
                    className="mt-1 w-full text-[11px] font-medium hover:underline text-center cursor-pointer"
                  >
                    View all plans
                  </button>
                </Link>
          ...
          <section className="lg:col-span-2 space-y-4 md:space-y-8">
            ...
            <Card className="rounded-xl shadow-none border border-gray-200 p-3 md:p-8">
              <CardContent className="p-0 space-y-6">
                <h2 className="text-lg md:text-2xl font-semibold font-montserrat">
                  Basic Information
                </h2>
            ...
            <div className="flex justify-end pt-2">
              <Button
                ...
                className="px-10 py-6 text-[16px] text-white rounded-lg shadow-none cursor-pointer"
              >
...
export default ConsultingoProfilePage;
    ...
    <div className="min-h-screen py-12 px-4 sm:px-8 md:px-20 font-montserrat">
      <div className="container mx-auto space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <Skeleton className="h-5 w-72 mx-auto rounded-md" />
          <div className="w-20 h-1 mx-auto mt-4 rounded-full" />
        </div>
          ...
          <aside className="lg:col-span-1 space-y-8">
            ...
            <Card className="rounded-xl shadow-none border border-gray-200 p-6 py-[30px] h-fit">
              <CardContent className="p-0 flex flex-col gap-4 w-full">
                ...
                <Skeleton className="mt-1 h-3 w-24 mx-auto rounded-md " />
              </CardContent>
            </Card>
          </aside>
