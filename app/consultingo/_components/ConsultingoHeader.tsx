          ...
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              <div className="relative group cursor-pointer">
                <button
                  type="button"
                  className="font-lexend cursor-pointer text-sm inline-flex items-center gap-1 md:text-[16px]"
                >
                  Services
            ...
            <div className="hidden md:flex md:items-center">
              {auth.isAuthenticated ? (
                ...
                <Button
                  ...
                  className="cursor-pointer bg-[var(--pri)] text-white border border-white rounded-full text-sm px-6 w-fit inline-flex items-center gap-2"
                >
                  Login
                  <span>
