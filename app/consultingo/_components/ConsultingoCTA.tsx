  ...
  return (
    ...
    >
      <div className="border border-[#0000001A] rounded-t-[30px] p-8 pb-16  md:p-[80px] md:pb-[230px] bg-[var(--sec)]/5 flex flex-col items-center justify-center gap-8">
        <h2 className="font-semibold text-[22px]/[26px] md:text-[54px]/[64px] text-[var(--sec)] font-fraunces text-center">
          {content?.heading}
        </h2>
        <Link
          href={content?.button?.link ?? "/"}
          className="bg-[var(--pri)] rounded-[30px] py-3 px-10 text-white flex items-center gap-2 cursor-pointer"
        >
