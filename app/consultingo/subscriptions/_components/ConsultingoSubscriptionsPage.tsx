      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-20 py-10">
        <Accordion type="single" collapsible className="w-full space-y-3">
          ...
          >
            ...
            <AccordionContent className="py-4 text-sm text-slate-700">
        ...
        <div className="mx-auto">
          <div>
            <div className="my-3">
              <h2 className="font-marcellus font-semibold text-xl my-2 text-[var(--pri)]">
                Payment Schedule
              </h2>
              <div>
...
export default ConsultingoSubscriptionsPage;
