...
const DefaultLogin = () => {
  ...
  return (
    <main className="flex-grow flex h-[80vh] items-center justify-center py-12 px-4">
            ...
            <div className="space-y-6">
              <div className="text-center mb-6">
                <button
                  ...
                  className="cursor-pointer underline font-montserrat text-sm font-medium text-blue-500"
                  disabled={loading}
                >
              ...
              <div>
                <label className="block text-sm mb-2 font-montserrat font-bold">
                ...
                <div className="flex gap-3 flex-col">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border font-montserrat border-gray-300 rounded-lg focus:outline-none"
                    disabled={loading}
                    style={{
            ...
            <div className="space-y-6">
              ...
              <div className="text-center mt-2">
                <button
                  ...
                  className="text-sm cursor-pointer font-medium underline font-montserrat"
                  disabled={loading}
                >
