...
const DefaultSubscriptionsPage = () => {
  const primaryColor = "#2952A2";
  ...
  if (isPageLoading) {
    return (
      <main
        className="flex-grow font-montserrat bg-[var(--sec)]/10"
        style={
          {
            "--pri": primaryColor,
            "--sec": secondaryColor,
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-20 py-10">
        ...
        <div className="mx-auto">
          <div>
            <div className="my-3">
              <h2 className="font-montserrat font-semibold text-xl my-2 text-[var(--pri)]">
                Payment Schedule
              </h2>
              <div>
...
export default DefaultSubscriptionsPage;
