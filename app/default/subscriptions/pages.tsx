...
import DefaultSubscriptionsPage from "./_components/DefaultSubscriptionsPage";
...
const DefaultSubscriptionsRoot = () => {
  return (
    <Suspense fallback={<PlanDetailsSkeleton />}>
      <DefaultSubscriptionsPage />
    </Suspense>
  );
};

export default DefaultSubscriptionsRoot;
