...
const FitkitProfilePage = ({
  ...
  return (
    <div
      className="min-h-screen py-12 px-4 sm:px-8 md:px-20 font-archivo bg-[#F8F7F4]"
      style={
        {
          "--pri": primaryColor,
          "--sec": secondaryColor,
    ...
    >
      <div className="container mx-auto space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-xl md:text-4xl font-bold font-kanit uppercase tracking-tight text-[var(--pri)]">
            Profile Settings
          </h1>
            ...
            <Card className="rounded-xl shadow-none border border-gray-200 p-3 md:p-6 md:py-[30px] h-fit">
              <CardContent className="p-0 flex md:flex-col items-center justify-start md:justify-center gap-6">
                ...
                <div className="space-y-1 md:text-center">
                  <p className="text-xl font-medium text-[var(--pri)] font-kanit">
            ...
            <Card className="rounded-xl shadow-none border border-gray-200 p-3 md:p-6 md:py-[30px] h-fit">
              <CardContent className="p-0 flex flex-col gap-4 w-full">
                ...
                <div className="flex items-center justify-between w-full mb-1">
                  <p className="text-base font-medium text-[var(--pri)] font-kanit">
                    Subscribed Plans
                  </p>
          ...
          <section className="lg:col-span-2 space-y-4 md:space-y-8">
            ...
            <Card className="rounded-xl shadow-none border border-gray-200 p-3 md:p-8">
              <CardContent className="p-0 space-y-6">
                <h2 className="text-lg md:text-2xl font-medium  text-[var(--pri)] font-kanit">
                  Basic Information
                </h2>
            ...
            <div className="flex justify-end pt-2">
              <Button
                ...
                className="px-10 py-6 text-[16px] text-white uppercase rounded-none shadow-none bg-[var(--sec)] cursor-pointer font-kanit"
              >
...
export default FitkitProfilePage;
