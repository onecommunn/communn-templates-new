...
const FitkitPaymentsRoot = () => {
  ...
  return (
    <section
      className="min-h-screen py-6 px-4 sm:px-8 md:px-20 font-archivo bg-[#F8F7F4]"
      style={
        {
          "--pri": primaryColor,
          "--sec": secondaryColor,
    ...
    >
      <div className="container mx-auto space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-xl md:text-4xl font-bold font-kanit tracking-tight text-[var(--pri)]">
            Payments
          </h1>
...
export default FitkitPaymentsRoot;
