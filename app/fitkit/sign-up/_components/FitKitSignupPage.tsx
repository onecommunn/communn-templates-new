...
const FitKitSignupPage = ({
  ...
  return (
    <main
      className="flex-grow flex h-[85vh] items-center justify-center pb-2 font-archivo  bg-[var(--sec)]  border-t border-[#383D46]"
      style={
        {
          "--pri": primaryColor,
          "--sec": secondaryColor,
          ...
          >
            ...
            <div>
              ...
              <Input
                ...
                required
                className="w-full  border col-span-12 border-[var(--sec)]/40 md:col-span-4 rounded-none h-12 placeholder:text-[#6B7586] text-white md:text-lg px-[30px] font-archivo"
              />
              ...
              <button
                ...
                className={`${
                  isFormValid && !isLoading
                    ...
                    : "bg-[var(--sec)]/40 cursor-not-allowed"
